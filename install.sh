...
REPO="yaacov/kubectl-debug-queries"
BINARY_NAME="kubectl-debug_queries"
ARCHIVE_PREFIX="kubectl-debug-queries"
...
cat > "${INSTALL_DIR}/kubectl_complete-debug_queries" << 'SCRIPT'
#!/usr/bin/env bash
kubectl-debug_queries __complete "$@"
SCRIPT
chmod +x "${INSTALL_DIR}/kubectl_complete-debug_queries"

ln -sf "${INSTALL_DIR}/kubectl_complete-debug_queries" "${INSTALL_DIR}/oc_complete-debug_queries"

echo ""
info "Installed files:"
echo "  ${INSTALL_DIR}/${BINARY_NAME}"
echo "  ${INSTALL_DIR}/kubectl_complete-debug_queries"
echo "  ${INSTALL_DIR}/oc_complete-debug_queries"
echo ""
...
echo "  kubectl debug-queries --help"
